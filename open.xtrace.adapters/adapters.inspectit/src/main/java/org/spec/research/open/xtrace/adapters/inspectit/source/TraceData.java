...
public class TraceData {
	...
	public TraceData(List<InvocationSequenceData> invocationSequenceDatas, List<PlatformIdent> platformIdents, List<Span> spans) {
	...
	/**
	 * @param invocationSequenceDatas
	 *            the invocationSequenceDatas to set
	 */
	public void setInvocationSequenceDatas(List<InvocationSequenceData> invocationSequenceDatas) {
		this.invocationSequenceDatas = invocationSequenceDatas;
	}
